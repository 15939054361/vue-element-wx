  ...
  <div class="addShop">
    ...
    <el-form :ref="form" :rules="rules" :model="form" label-width="120px">
      ...
      <el-form-item label="详细地址:" class="address_box" prop="address">
        <el-autocomplete v-model="form.address" :fetch-suggestions="querySearchAsync" placeholder="请输入内容:" @select="handleSelect"></el-autocomplete>
      ...
      <el-form-item label="营业时间:">
        ...
        <el-col :span="8">
          <el-time-select :picker-options="{
           ...
           }" placeholder="结束时间" v-model="form.endTime"></el-time-select>
        </el-col>
      </el-form-item>
      <el-form-item label="店铺头像:" prop="image_path">
        <el-upload class="avatar-uploader" :action="baseUrl+'/v1/addimg/shop'" :show-file-list="false" :on-success="handleAvatarSuccess1" :before-upload="beforeAvatarUpload1">
          <img v-if="form.image_path " :src="imgBaseUrl+form.image_path " class="avatar" />
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
      <el-form-item label="营业执照:">
        <el-upload class="avatar-uploader" :action="baseUrl+'/v1/addimg/shop'" :show-file-list="false" :on-success="handleAvatarSuccess2" :before-upload="beforeAvatarUpload2">
          <img v-if="form.business_license_image" :src="imgBaseUrl+form.business_license_image" class="avatar" />
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
      <el-form-item label="餐饮许可证:">
        <el-upload class="avatar-uploader" :action="baseUrl+'/v1/addimg/shop'" :show-file-list="false" :on-success="handleAvatarSuccess3" :before-upload="beforeAvatarUpload3">
          <img v-if="form.catering_service_license_image" :src="imgBaseUrl+form.catering_service_license_image " class="avatar" />
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
      <el-form-item label="活动优惠:">
        <el-select @change="selectActive" v-model="activeValue" placeholder="请选择">
          <el-option v-for="item in activeOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
