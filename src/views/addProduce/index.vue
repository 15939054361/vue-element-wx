  ...
  <div class="wraper">
    <el-dialog title="添加规格" :visible.sync="dialogFormVisible">
      <el-form :model="form" ref="form">
        <el-form-item label="规格" :label-width="formLabelWidth" prop="specs" :rules="[
          ...
          <el-card>
            <el-form :model="sortData" ret="sortData" label-width="120px" class="demo-sort">
              <el-form-item prop="sort" label="食品种类名称">
                <el-select v-model="sortData.sort" placeholder="请选择" @change="handle" style="width:100%;">
            ...
            <el-collapse>
              <el-collapse-item title="点击添加食品种类">
                <el-form ref="addform" :model="addform" label-width="100px">
                  <el-form-item label="食品种类" prop="name" :rules="[{ required: true, message: '请输入要添加的食品种类', trigger: 'blur' },]">
        ...
        <el-col :span="14">
          <el-card class="box-card">
            <el-form :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="120px" class="demo-dynamic">
              <el-form-item prop="name" label="食品名称" :rules="[{ required: true, message: '请输入食品名称', trigger: 'blur' },]">
              ...
              <el-form-item label="上传图片" prop="image_path" :rules="[{ required: true, message: '请上传图片', trigger: 'change' },]">
                <el-upload class="avatar-uploader" action="https://elm.cangdu.org/v1/addimg/food" :show-file-list="false" :on-success="handleAvatarSuccess">
                  <img v-if="dynamicValidateForm.image_path" :src="imgBaseUrl+dynamicValidateForm.image_path" class="avatar" />
              ...
              <div v-else>
                <el-form-item label="包装费">
                  <el-input-number v-model="dynamicValidateForm.specs[0].packing_fee" @change="handleChangePacking_fee" :min="1" :max="10" label="包装费"></el-input-number>
                </el-form-item>
                <el-form-item label="价格">
                  <el-input-number v-model="dynamicValidateForm.specs[0].price" @change="handleChangePrice" :min="1" :max="10" label="价格"></el-input-number>
                </el-form-item>
              </div>
